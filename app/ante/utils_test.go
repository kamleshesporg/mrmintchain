...
import (
	...
	authz "github.com/kamleshesporg/mrmintchain/x/auth"
	sdkante "github.com/kamleshesporg/mrmintchain/x/auth/ante"
	...
	ante "github.com/kamleshesporg/mrmintchain/app/ante"
	...
	evtypes "github.com/kamleshesporg/mrmintchain/x/evidence/types"
...
func (suite *AnteTestSuite) SetupTest() {
	...
	suite.app = app.Setup(checkTx, func(app *app.MrmintchainApp, genesis simapp.GenesisState) simapp.GenesisState {
...
func (suite *AnteTestSuite) createBaseTxBuilder(msg sdk.Msg, gas uint64) client.TxBuilder {
	...
	txBuilder.SetFeeAmount(sdk.NewCoins(
		sdk.NewCoin("mnt", sdk.NewInt(10000)),
	))
