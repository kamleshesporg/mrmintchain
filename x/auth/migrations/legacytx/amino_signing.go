...
import (
	...
	authsigning "github.com/cosmos/cosmos-sdk/x/auth/signing" // ✅ Updated import
)

// stdTxSignModeHandler is a SignModeHandler that handles SIGN_MODE_LEGACY_AMINO_JSON
type stdTxSignModeHandler struct{}

// NewStdTxSignModeHandler creates a new stdTxSignModeHandler
func NewStdTxSignModeHandler() authsigning.SignModeHandler {
	return &stdTxSignModeHandler{}
}

// assert interface implementation
var _ authsigning.SignModeHandler = &stdTxSignModeHandler{} // ✅ Use pointer type
...
func (h *stdTxSignModeHandler) Modes() []signingtypes.SignMode {
	return []signingtypes.SignMode{signingtypes.SignMode_SIGN_MODE_LEGACY_AMINO_JSON}
}

// GetSignBytes implements SignModeHandler.GetSignBytes
func (h *stdTxSignModeHandler) GetSignBytes(
	mode signingtypes.SignMode,
	data authsigning.SignerData, // ✅ Correct type
	tx sdk.Tx,
) ([]byte, error) {
	...
	return StdSignBytes(
		...
		data.AccountNumber,
		data.Sequence,
		stdTx.GetTimeoutHeight(),
		StdFee{Amount: stdTx.GetFee(), Gas: stdTx.GetGas()},
		tx.GetMsgs(),
		stdTx.GetMemo(),
		nil,
	), nil
