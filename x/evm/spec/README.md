...
The `x/evm` is part of the [mrmintchain library](https://pkg.go.dev/github.com/kamleshesporg/mrmintchain). For an example of how mrmintchain can be used on any Cosmos-SDK chain, please refer to [Evmos](https://www.github.com/tharsis/evmos).
