...
import (
	...
	v5 "github.com/kamleshesporg/mrmintchain/x/evm/migrations/v5"
	v5types "github.com/kamleshesporg/mrmintchain/x/evm/migrations/v5/types"
...
func TestMigrate(t *testing.T) {
	...
	kvStore.Set(types.ParamStoreKeyEVMDenom, []byte("mnt"))
	...
	require.Equal(t, "mnt", params.EvmDenom)
