...
var _ mrmintchain.EVMTxIndexer = &KVIndexer{}
...
func (kv *KVIndexer) GetByTxHash(hash common.Hash) (*mrmintchain.TxResult, error) {
	...
	var txKey mrmintchain.TxResult
...
func (kv *KVIndexer) GetByBlockAndIndex(blockNumber int64, txIndex int32) (*mrmintchain.TxResult, error) {
...
func isEthTx(tx sdk.Tx) bool {
	...
	if len(opts) != 1 || opts[0].GetTypeUrl() != "/mrmintchain.evm.v1.ExtensionOptionsEthereumTx" {
		return false
	}
	return true
}
...
func saveTxResult(codec codec.Codec, batch dbm.Batch, txHash common.Hash, txResult *mrmintchain.TxResult) error {
