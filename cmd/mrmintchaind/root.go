...
import (
	...
	authcmd "github.com/kamleshesporg/mrmintchain/x/auth/client/cli"
	...
	mrmintchainclient "github.com/kamleshesporg/mrmintchain/client"
	"github.com/kamleshesporg/mrmintchain/client/debug"
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := servercfg.AppConfig(mrmintchain.AttoPhoton)
	...
	rootCmd.AddCommand(
		mrmintchainclient.ValidateChainID(
		...
		mrmintchainclient.NewTestnetCmd(app.ModuleBasics, banktypes.GenesisBalancesIterator{}),
		debug.Cmd(),
		config.Cmd(),
	)
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		mrmintchainclient.KeyCommands(app.DefaultNodeHome),
	)
