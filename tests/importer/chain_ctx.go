...
// transactions. There should only be a single implementation in mrmintchain. For
// the purposes of mrmintchain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: mrmintchain will distribute the fees out to validators, so the structure
