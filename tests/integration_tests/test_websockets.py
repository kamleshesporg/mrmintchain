def test_single_request_netversion(mrmintchain):
    mrmintchain.use_websocket()
    eth_ws = mrmintchain.w3.provider
...
def test_batch_request_netversion(mrmintchain):
    return


def test_ws_subscribe_log(mrmintchain):
    return


def test_ws_subscribe_newheads(mrmintchain):
    return
