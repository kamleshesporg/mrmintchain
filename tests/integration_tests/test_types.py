...
def test_block(mrmintchain, geth):
    get_blocks(mrmintchain, geth, False)
    get_blocks(mrmintchain, geth, True)


def get_blocks(mrmintchain_rpc_ws, geth, with_transactions):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    mrmintchain_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [mrmintchain_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_syncing(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(mrmintchain_rpc_ws, geth):
    # on mrmintchain the proof query will fail for block numbers <= 2
...
def test_get_code(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(mrmintchain_rpc_ws, geth):
    w3: Web3 = mrmintchain_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(mrmintchain_rpc_ws, geth):
...
def test_incomplete_send_transaction(mrmintchain_rpc_ws, geth):
