// This is a test utility for mrmintchain's Web3 JSON-RPC services.
//
// To run these tests please first ensure you have the mrmintchaind running
// and have started the RPC service with `mrmintchaind rest-server`.
//
...
func TestEth_protocolVersion(t *testing.T) {
	expectedRes := hexutil.Uint(mrmintchain.ProtocolVersion)
