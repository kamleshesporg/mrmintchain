...
func (b *Backend) GetGasUsed(res *mrmintchain.TxResult, price *big.Int, gas uint64) uint64 {
	// patch gasUsed if tx is reverted and happened before height on which fixed was introduced
	// to return real gas charged
	// more info at https://github.com/kamleshesporg/mrmintchain/pull/1557
...
func (b *Backend) GetTxByEthHash(hash common.Hash) (*mrmintchain.TxResult, error) {
	if b.indexer != nil {
...
func (b *Backend) GetTxByTxIndex(height int64, index uint) (*mrmintchain.TxResult, error) {
	if b.indexer != nil {
...
func (b *Backend) queryTendermintTxIndexer(query string, txGetter func(*rpctypes.ParsedTxs) *rpctypes.ParsedTx) (*mrmintchain.TxResult, error) {
