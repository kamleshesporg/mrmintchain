...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*mrmintchain.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*mrmintchain.TxResult, error)
...
func NewBackend(
	...
	chainID, err := mrmintchain.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
