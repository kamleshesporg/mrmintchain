...
import (
	...
	"github.com/kamleshesporg/mrmintchain/rpc/backend"
	"github.com/kamleshesporg/mrmintchain/rpc/namespaces/ethereum/debug"
	"github.com/kamleshesporg/mrmintchain/rpc/namespaces/ethereum/eth"
	"github.com/kamleshesporg/mrmintchain/rpc/namespaces/ethereum/eth/filters"
	"github.com/kamleshesporg/mrmintchain/rpc/namespaces/ethereum/miner"
	"github.com/kamleshesporg/mrmintchain/rpc/namespaces/ethereum/net"
	"github.com/kamleshesporg/mrmintchain/rpc/namespaces/ethereum/personal"
	"github.com/kamleshesporg/mrmintchain/rpc/namespaces/ethereum/txpool"
	"github.com/kamleshesporg/mrmintchain/rpc/namespaces/ethereum/web3"
...
type APICreator = func(
	...
	indexer mrmintchain.EVMTxIndexer,
) []rpc.API
...
func init() {
	apiCreators = map[string]APICreator{
		...
		Web3Namespace: func(*server.Context, client.Context, *rpcclient.WSClient, bool, mrmintchain.EVMTxIndexer) []rpc.API {
			return []rpc.API{
				{
		...
		NetNamespace: func(_ *server.Context, clientCtx client.Context, _ *rpcclient.WSClient, _ bool, _ mrmintchain.EVMTxIndexer) []rpc.API {
			return []rpc.API{
				{
		...
		TxPoolNamespace: func(ctx *server.Context, _ client.Context, _ *rpcclient.WSClient, _ bool, _ mrmintchain.EVMTxIndexer) []rpc.API {
			return []rpc.API{
				{
