...
func DefaultConfig() Config {
	...
	return Config{
		...
		ChainID:           fmt.Sprintf("mrmintchain_%d-1", tmrand.Int63n(9999999999999)+1),
		NumValidators:     4,
		BondDenom:         mrmintchain.AttoPhoton,
		MinGasPrices:      fmt.Sprintf("0.000006%s", mrmintchain.AttoPhoton),
		AccountTokens:     sdk.TokensFromConsensusPower(1000, mrmintchain.PowerReduction),
		StakingTokens:     sdk.TokensFromConsensusPower(500, mrmintchain.PowerReduction),
		BondedTokens:      sdk.TokensFromConsensusPower(100, mrmintchain.PowerReduction),
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	if !mrmintchain.IsValidChainID(cfg.ChainID) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		customAppTemplate, _ := config.AppConfig(mrmintchain.AttoPhoton)
