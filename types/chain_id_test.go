...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "mrmintchain_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "mrmintchain_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "mrmintchain_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "mrmintchain_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "mrmintchain_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "mrmintchain_mrmintchain_9000-1", true, nil,
		},
		{
			"invalid epoch, undefined", "mrmintchain_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "mrmintchain_" + strings.Repeat("1", 40) + "-1", true, nil,
		},
	}
